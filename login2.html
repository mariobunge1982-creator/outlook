...
<title>Introducir contraseña - Demo</title>
...
body {
    ...
    background:
        radial-gradient(
            ...
            rgba(246,248,252,.72) 44%,
            rgba(232,238,247,.9) 100%
        ),
        linear-gradient(
            135deg,
            #edf4fa,
...
<main class="page">
    ...
    <section class="login-card">
        ...
        <form
            id="passwordForm"
            onsubmit="return continuar(event)">
...
/*
    ...
    La primera pantalla debería haber hecho:
...
function continuar(event) {
    ...
    if (!password) {
        ...
        notice.textContent =
            "Introduce una contraseña de demostración.";
    ...
    /*
        ...
        no se guarda y no se transmite.
    */

    notice.textContent =
        "Demostración: no se envían ni almacenan datos.";
...
function mostrarAyuda() {
    ...
    document.getElementById(
        ...
        "Demostración: opción de recuperación.";
...
function mostrarOpciones() {
    ...
    document.getElementById(
        ...
        "Demostración: aquí aparecerían otras formas de acceso.";
...
if (cuenta) {
    document.getElementById("accountDisplay").textContent = cuenta;
}
